<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="castMember.aspx.cs" Inherits="_666Music.castMember" %>
                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                <div class="col-md-4 col-md-offset-4">
                                    <h1 style="margin-bottom:3rem">Cast Member</h1>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox runat="server" required="required" Enabled="True" name="BrandName" ID="TextBox8" class="form-control input-sm" placeholder="  Actor Number" Style="margin-left: 0"></asp:TextBox>
                                                    </td>
                                                </tr>
